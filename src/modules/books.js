...
export function books() {
  ...
  create_page(
    ...
    tag("div", {},
      ...
      tag("progress", {"style":"border: solid .1em var(--ac)", "value":`${livros_lidos}`, "max":`${total_de_livros}`}),
      tag("p", {"style":"margin: 0; text-align: center"},
        "Li "                                                                  +
        `<span style='color: var(--ac)'>${livros_lidos}</span> `    +
        "de "                                                                  +
        `<span style='color: var(--ac)'>${total_de_livros}</span> ` +
