...
Nas últimas 48 horas eu estou fazendo alguns updates no meu "pequeno" projeto de [[https://codeberg.org/tukain/raylib.ha][/bindings/ da Raylib para a Hare]]. Em grande parte, colocando documentação (até agora me arrependo de não ter adicionado os benditos comentários desde o início). Quando dá na telha, eu também adiciono novas bindings.
...
Um exemplo disso é o setup do meu computador. Ele tem [[https://alpinelinux.org/][Alpine Linux]] e eu uso o [[https://swaywm.org/][Sway]]. Motivo? Porque para mim, é mais eficiente eu ter um ambiente onde eu posso integrar [[https://pt.wikipedia.org/wiki/Shell_script][/Shell Scripts/]] com facilidade para automatizar tarefas extremamente complexas como *TOCAR UMA PLAYLIST DE MÚSICAS LO-FI QUE EU TENHO BAIXADA NO MEU COMPUTADOR*.

Eu queria tá de sacanagem, mas eu não tô kkkkkk

Além de claro, o fato de que eu refaço esse site do 0 sempre que eu fico enjoado com como ele está. E eu não posso nem dizer que eu não sou tão ativo no desenvolvimento das /bindings/ porquê a sintáxe da [[https://harelang.org/][Hare]] é complicada ou algo do gênero. Eu não ironicamente já usei e customizei um /Window Manager/ que é configurado com [[https://pt.wikipedia.org/wiki/XML][XML]], e gostei! ([[https://labwc.github.io/][Labwc]]).
...
E outra coisa né, se eu me dei o trabalho de fazer uma "[[https://tukainpng.neocities.org/modules/common.js][imitação do React]]" só para criar esse site (com o markup dos [[https://tukainpng.neocities.org/modules/db/posts.js][posts]] sendo copiado do [[https://orgmode.org/][Org mode]]), eu consigo fazer umas bindings >:(.
